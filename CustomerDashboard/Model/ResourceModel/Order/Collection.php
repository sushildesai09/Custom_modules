 ...
 */
namespace Nisl\CustomerDashboard\Model\ResourceModel\Order;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Order\Collection
{
     ...
     * @return $this
     */
    public function prepareSummary($range, $customStart, $customEnd, $isFilter = 0,$customerId)
    {   
        
        $this->checkIsLive($range);
        if ($this->_isLive) {
            
            $this->_prepareSummaryLive($range, $customStart, $customEnd, $isFilter,$customerId);
        } else {
     ...
     * @return $this
     */
    protected function _prepareSummaryLive($range, $customStart, $customEnd, $isFilter = 0,$customerId)
    {
     ...
     * @return $this
     */
    public function addCreateAtPeriodFilter($period,$customerId,$fromdate=0,$todate=0)
    {

        
       
        list($from, $to) = $this->getDateRange($period, $fromdate, $todate, true);
