 ...
 */
class Graph extends AbstractDashboard
{
    /**
     * Api URL
     */
     ...
     * @var string
     */
    protected $_template = 'Nisl_CustomerDashboard::dashboard/graph.phtml';
    ...
    public function getChartUrl($directUrl = true)
    {
      ...
      // echo $this->getDataHelper()->getParam('period');exit;
        $params = [
            'cht' => 'lc',
            'chls' => '7',
        ...
        if($this->getDataHelper()->getParam('period') == 'custom'){
        ...
        while ($dateStart <= $dateEnd) {
           ...
           // print_r($this->getAllSeries());exit;
        ...
        return $this->getUrl('adminhtml/dashboard/tunnel', ['_query' => $params]);
    }
    ...
    {
        //$objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        //$orders = $objectManager->create('Magento\Reports\Model\ResourceModel\Order\Collection');
    ...
    protected function _prepareData()
    {
        if ($this->_dataHelper !== null) { 
            ...
            $this->getDataHelper()->setParam(
                'period',
                $period && in_array($period, $availablePeriods) ? $period : '1y'
            );
        }
    }
}
