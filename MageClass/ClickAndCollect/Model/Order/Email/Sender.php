 ...
 */
namespace MageClass\ClickAndCollect\Model\Order\Email;
...
abstract class Sender
{
    ...
    protected function checkAndSend(Order $order)
    {
        ...
        if($order->getShippingMethod() == 'clickandcollect_clickandcollect' && $this instanceof  \MageClass\ClickAndCollect\Model\Order\Email\Sender\ShipmentSender){
            $this->templateContainer->setTemplateId(17);
        } else {
			$this->templateContainer->setTemplateId(5);
		}
        try {
            $sender->send();
        } catch (\Exception $e) {
